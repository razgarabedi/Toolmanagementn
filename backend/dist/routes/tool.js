...
router.get('/my-tools', auth_1.auth, tool_1.getMyTools);
...
router.put('/:id', [auth_1.auth, (0, auth_1.authorize)(['admin', 'manager']), upload_1.default.fields([{ name: 'instanceImage', maxCount: 1 }, { name: 'attachments' }])], tool_1.updateTool);
