            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded shadow-md">
                    ...
                    <ul className="space-y-2">
                        <li>Available: <span className="font-semibold">{inventory?.available || 0}</span></li>
                        <li>In Use: <span className="font-semibold">{inventory?.in_use || 0}</span></li>
                        <li>In Maintenance: <span className="font-semibold">{inventory?.in_maintenance || 0}</span></li>
                        <li>Booked: <span className="font-semibold">{inventory?.booked || 0}</span></li>
                    </ul>
                </div>
                ...
                <div className="bg-white p-6 rounded shadow-md">
                    ...
                    <ul className="space-y-2">
                        <li>Scheduled: <span className="font-semibold">{maintenance?.scheduled || 0}</span></li>
                        <li>In Progress: <span className="font-semibold">{maintenance?.['in-progress'] || 0}</span></li>
                        <li>Completed: <span className="font-semibold">{maintenance?.completed || 0}</span></li>
                    </ul>
                </div>

                {/* Utilization Summary */}
                <div className="bg-white p-6 rounded shadow-md">
                    <h2 className="text-xl font-bold mb-4">Top 5 Most Used Tools</h2>
